        ...
        try{
            if(!dao.connectionToString()) {
                ...
                try {
                    ...
                    errorText.setText("");
                    try {
                        tdao.addTransaction(dao.getCurrency(currencyF), dao.getCurrency(currencyT), Double.parseDouble(fromText.getText()), Double.parseDouble(toText.getText()));
                    } catch (Exception e) {
